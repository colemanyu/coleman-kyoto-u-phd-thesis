\begin{table*}[ht] % *!
\centering
\caption{The accuracy comparison for eight distance measures of the ten datasets (train split).}
...
$\overline{P@1}$ & $\overline{P@3}$ \\
\midrule
SonyAIBORobotSurface1 & 0.30 & 0.70 & 0.90 & 1.00 & \textbf{1.00} & 1.00 & 0.80 & 0.85 & 0.50 & 0.70 & 0.80 & 0.85 & \textbf{1.00} & 1.00 & \textbf{1.00} & 1.00 \\
