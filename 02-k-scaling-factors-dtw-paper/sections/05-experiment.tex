...
When $P$ is not given, the value of $P$ can be determined as follows.
...
With the computational efficiency \texttt{PSED\_parallel\_bsf}, we are now able to conduct the experiment on all the data, including both the training set and the test set.
