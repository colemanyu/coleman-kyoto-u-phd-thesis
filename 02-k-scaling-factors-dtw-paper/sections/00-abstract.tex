...
It employs other distance measures as its base distance measure.
...
Two additional speedup techniques have been proposed, which achieve 8.59X to 176.14X speedup.
We also demonstrate the use of a lower bound when DTW is employed as the base distance measure to accelerate PSD computation.
