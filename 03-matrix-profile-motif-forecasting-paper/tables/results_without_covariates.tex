\begin{table}[htbp]
    \centering
    \caption{Experimental Results without original covariates (bold represents the best result and underlined represents the second best) (* refers to the results reported from~\cite{elsayed2021we}) (For the GBRT-related methods, we round to the nearest 4 decimal places for better comparison, for the others, we round to the 3 decimal places).}
    ...
    \begin{tabular}{llccccccc}
        ...
        & RMSE & 55.405 & 5.462 & 5.983 & 15.357 & 5.610 & \underline{5.575} & \textbf{5.557} \\
        & WAPE & 0.981 & 0.057 & 0.060 & 0.183 & 0.051 & \underline{0.051} & \textbf{0.051} \\
        ...
        & MAE & 0.013 & \textbf{0.011} & 0.016 & 0.101 & \underline{0.012} & \underline{0.012} & \underline{0.012} \\
        \bottomrule
    \end{tabular}
    }
\end{table}
