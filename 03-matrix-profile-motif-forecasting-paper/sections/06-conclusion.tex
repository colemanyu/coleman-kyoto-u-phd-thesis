...
The information includes the similarity and the immediate subsequences.
Experiment shows that the augmented data allow the existing model to have a better prediction result in the task of time series forecasting in terms of three evaluation metrics, which are RMSE, WAPE, and MAE.
