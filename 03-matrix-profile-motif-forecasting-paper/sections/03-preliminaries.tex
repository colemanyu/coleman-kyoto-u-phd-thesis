...
It is defined as $\ceil{m/2}$ before and after the location of $Q$~\cite{yeh2016matrix}. The community implementation uses $\ceil{m/4}$ instead~\cite{law2019stumpy}.
We use $\ceil{m/4}$ as the exclusion zone in this study.
...
\subsection{Left Matrix Profile} % *!
