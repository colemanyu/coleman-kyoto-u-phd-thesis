...
Once the location of $NN^L_i$ is identified via the $I^L$, we extract the following information about $NN^L_i$ as in Algorithm~\ref{alg:feature_eng}. They are used as $u_i$ for $y_i$.
...
$\textcolor{tab:red}{y_{i-w+1}, y_{i-w+2}, \dots, y_i}, \textcolor{tab:green}{u_i^1, u_i^2, \dots, u_i^{M_u}}, \textcolor{tab:blue}{t_{j+1}, t_{j+2}, \dots, t_{j+l}}$
with length $w + M_x + l$.
