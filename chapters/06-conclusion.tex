...
In this thesis, we contribute to time series analysis by addressing two aspects, with applications in bioinformatics.
...
% Second study
The second study develops a new distance measure framework, namely PSD. It aims to release a fundamental assumption that the prior studies have overlooked.
...
Future works on it are as follows.
