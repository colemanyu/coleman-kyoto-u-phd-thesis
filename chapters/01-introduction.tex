...
In Chapter~\ref{ch:preliminaries}, we review some of the basic knowledge in biology and time series data mining, in particular, we focus on distance measures and the main core underlying Rocket-based classifiers, which is the Ridge classifier.
%
