...
First, in chapter~\ref{ch:mtsccleav}, we demonstrate a machine learning approach to analyze a biology problem.
We propose the usage of the base pair probability sequence from the predicted secondary structure of RNA sequence as new information for the classification task. We apply Rocket-based classifiers to identify the human dicer cleavage sites.
...
Second in Chapter~\ref{ch:ksfdtw}, we solve an algorithmic problem on distance measure.
...
Third in Chapter~\ref{ch:mpmf}, we improve a forecaster with the usage of a data mining primitive, namely Matrix Profile.
...
The experiment shows that this simple method can improve the accuracy.
