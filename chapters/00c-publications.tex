...
\begin{itemize}
    ...
    % ~\cite{yu2017melody}
    \begin{itemize}
        \item In this study, we apply a data mining method called frequent pattern mining to capture the relationships between the pitch trend in the melody and the tone trend in lyrics and use these relationships to create a new melody for the user-given lyrics. The pitch trend and the melody trend are both time series data. It motivates me to do time series analysis from a data mining perspective.
    \end{itemize}
